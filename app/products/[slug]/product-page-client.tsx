...
const PRODUCT_DETAILS: Record<string, {
  ...
  "gp-fertiliser-premium-garden-lawn": {
    ...
    howToUse:    "Sprinkle 30g per m² around the drip line of plants — not touching stems. Water in well after applying. Always apply to moist soil, never dry. Reapply every 6–8 weeks during the active growing season; halve frequency in winter.",
  ...
  "lawn-fertilizer-premium-granulated-concentrated": {
    benefits:    [
      ...
      "Slow-release granules feed your lawn for up to 12 weeks",
  ...
  "volcanic-dust-trace-elements": {
    ...
    howToUse:    "Broadcast 100–200g per m² over garden beds and water in. Or mix into potting mix at 10% by volume. Can also be added by the tablespoon to compost bins. Once or twice a year is enough — this is a slow-release mineral bank, not a weekly feed.",
  ...
  "glacial-milk": {
    benefits:    [
      ...
      "Strengthens plant cell walls and improves frost and drought tolerance",
      "Remineralises soils with slow-release natural minerals",
      "Supports seed germination and seedling establishment",
    ],
    howToUse:    "Mix 50g (about 1 tablespoon) per 9L watering can and apply to soil monthly. Or sprinkle as a fine top-dress and water in. For seed-raising mix, add 1 tablespoon per litre of mix before sowing. Safe for all plants, vegetables, and lawns.",
  ...
  "soil-health-conditioner": {
    benefits:    [
      ...
      "Helps plants access existing soil nutrients that are currently locked up",
      "Works synergistically with all BioGardeners fertilisers",
    ],
    howToUse:    "Dilute 50ml per 9L watering can and apply across soil in the early morning. For pots, use 25ml per 9L every 2 months to keep potting mix biology alive. Apply every 4–6 weeks for garden beds; monthly for potted plants.",
  ...
  "plant-spray": {
    ...
    howToUse:    "Spray directly onto leaves — top AND underside — ensuring full coverage. Apply in early morning or evening only, never in direct sunlight. For plants showing signs of pest or disease pressure, apply every 3–5 days for 3 rounds. For general plant health maintenance, apply fortnightly.",
  ...
  "bloom-n-yield": {
    benefits:    [
      ...
      "Sea minerals deliver calcium, magnesium, potassium, and a broad spectrum of trace elements",
      "Versatile — apply as a foliar spray, stem drench, or soil drench",
      "Suits all plants — from azaleas to zucchini, ornamentals to vegetables",
    ],
    howToUse:    "Apply every 2–4 weeks during the active growing and flowering season. Use as a foliar spray, stem drench, or soil drench. Apply in early morning or evening for best results. Best for tomatoes, capsicums, strawberries, roses, fruit trees, and all flowering and fruiting plants.",
    ingredients: "Sea minerals bio stimulants — calcium, magnesium, potassium, iodine, sulfur, boron, zinc, manganese, iron, and trace elements. 100% biodegradable.",
